...
final class MediaAdminSearchIndexer extends AbstractAdminIndexer
{
    ...
    /**
     * @return array<string, array{id: string, text: string, completion: list<string>}|array{id: string, text: string, fileName: mixed, private: bool, fileExtension: mixed, fileSize: int|null, path: mixed, mediaFolderId: mixed, title: array<string, string>, mediaFolder: array{name?: string, path?: string, defaultFolder?: array{entity: string}}, alt: array<string, string>, tags: list<array{id: string, _count: int}>, createdAt: string|null}>
     */
