...
final class CategoryAdminSearchIndexer extends AbstractAdminIndexer
{
    ...
    /**
     * @return array<string, array{id: string, text: string, completion: list<string>}|array{id: string, parentId: mixed, text: string, completion: list<string>, name: array<string, string>, active: bool, visible: bool, type: mixed, tags: list<array{id: string, _count: int}>, createdAt: string|null}>
     */
