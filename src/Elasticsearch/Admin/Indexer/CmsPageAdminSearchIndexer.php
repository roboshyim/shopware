...
final class CmsPageAdminSearchIndexer extends AbstractAdminIndexer
{
     ...
     *
     * @return array<string, array{id: string, text: string, completion: list<string>}|array{id: string, text: string, completion: list<string>, name: array<string, string>, type: mixed, createdAt: string|null}>
     */
