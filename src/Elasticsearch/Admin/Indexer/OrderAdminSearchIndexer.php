...
final class OrderAdminSearchIndexer extends AbstractAdminIndexer
{
     ...
     *     stateId?: mixed,
     *     stateMachineState?: array{id: mixed, _count: int}|null,
     *     salesChannelId?: mixed,
     *     affiliateCode?: mixed,
     *     campaignCode?: mixed,
     *     tags?: list<array{id: string, _count: int}>,
     *     billingAddress?: array{id: string, _count: int, countryId: string}|null,
     *     orderCustomer?: array{id: string, _count: int, customer: array{id: string, _count: int, groupId: string, customerNumber: string}|null}|null,
     *     lineItems?: list<array{id: string, _count: int, productId: string|null, payload: array{code: string|null}}>,
     *     primaryOrderTransaction?: array{id: string, _count: int, stateMachineState: array{id: string, _count: int}, paymentMethodId: string}|null,
     *     primaryOrderDelivery?: array{id: string, _count: int, stateMachineState: array{id: string, _count: int}, shippingMethodId: string, shippingOrderAddress: array{id: string, _count: int, countryId: string}}|null,
