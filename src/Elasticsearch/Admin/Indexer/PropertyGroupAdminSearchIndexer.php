...
final class PropertyGroupAdminSearchIndexer extends AbstractAdminIndexer
{
    ...
    /**
     * @return array<string, array{id: string, text: string, completion: list<string>}|array{id: string, text: string, completion: list<string>, name: array<string, string>, filterable: bool, createdAt: string|null}>
     */
