...
class ElasticsearchEntitySearchHydrator extends AbstractElasticsearchSearchHydrator
{
    ...
    /**
     * @param array{ hits?: array{ hits: array<int, array{_id?: string, _score?: float, _source?: array<mixed>, inner_hits?: array{ inner?: array<mixed>}}>, total?: array{value: int}}, aggregations?: array<string, array<string, mixed>>} $result
     */
