...
class SystemSetupCommandTest extends TestCase
{
    ...
    public function testEnvFileGenerationWithDumpEnv(): void
    {
        ...
        /** @phpstan-ignore require.fileNotFound (Also the existence of the file is checked above, PHPStan will only consider files, that always exist. See https://github.com/phpstan/phpstan/issues/12417) */
